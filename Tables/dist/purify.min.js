...
!(function (e, t) {
  ...
  const w = i([
    ...
    Y = a(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
    j = a(/^html$/i);
  var q = Object.freeze({ __proto__: null, MUSTACHE_EXPR: P, ERB_EXPR: F, TMPLIT_EXPR: H, DATA_ATTR: z, ARIA_ATTR: B, IS_ALLOWED_URI: W, IS_SCRIPT_OR_DATA: G, ATTR_WHITESPACE: Y, DOCTYPE_NAME: j });
  const X = function () {
  ...
  var V = (function t() {
    ...
    const a = r,
      c = a.currentScript,
      { DocumentFragment: s, HTMLTemplateElement: _, Node: N, Element: P, NodeFilter: F, NamedNodeMap: H = n.NamedNodeMap || n.MozNamedAttrMap, HTMLFormElement: z, DOMParser: B, trustedTypes: G } = n,
      Y = P.prototype,
      V = R(Y, 'cloneNode'),
      $ = R(Y, 'nextSibling'),
      Z = R(Y, 'childNodes'),
    ...
    const { MUSTACHE_EXPR: le, ERB_EXPR: ce, TMPLIT_EXPR: se, DATA_ATTR: ue, ARIA_ATTR: me, IS_SCRIPT_OR_DATA: fe, ATTR_WHITESPACE: pe } = q;
      ...
      it = function () {
        ...
        if (!nt || nt !== e) {
          if (
            ...
            e.CUSTOM_ELEMENT_HANDLING && rt(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Ee.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
            e.CUSTOM_ELEMENT_HANDLING && rt(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Ee.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
            e.CUSTOM_ELEMENT_HANDLING && 'boolean' == typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (Ee.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
            we && (be = !1),
            ke && (xe = !0),
            Fe &&
              ((he = b({}, [...C])),
    ...
    const mt = function (e) {
      ...
      Et = function (e) {
        ...
        if ((yt('uponSanitizeElement', e, { tagName: n, allowedTags: he }), e.hasChildNodes() && !Tt(e.firstElementChild) && E(/<[/\w]/g, e.innerHTML) && E(/<[/\w]/g, e.textContent))) return ft(e), !0;
        if (!he[n] || Ae[n]) {
          if (!Ae[n] && _t(n)) {
      ...
      At = function (e, t, n) {
        ...
        if (be && !_e[t] && E(ue, t));
          ...
          if (
            !(
              (_t(e) &&
                ((Ee.tagNameCheck instanceof RegExp && E(Ee.tagNameCheck, e)) || (Ee.tagNameCheck instanceof Function && Ee.tagNameCheck(e))) &&
                ((Ee.attributeNameCheck instanceof RegExp && E(Ee.attributeNameCheck, t)) || (Ee.attributeNameCheck instanceof Function && Ee.attributeNameCheck(t)))) ||
              ('is' === t && Ee.allowCustomizedBuiltInElements && ((Ee.tagNameCheck instanceof RegExp && E(Ee.tagNameCheck, n)) || (Ee.tagNameCheck instanceof Function && Ee.tagNameCheck(n))))
            )
          )
            return !1;
        } else if (Ge[t]);
    ...
    return (
      (o.sanitize = function (e) {
        ...
        return (
          De && he['!doctype'] && n.ownerDocument && n.ownerDocument.doctype && n.ownerDocument.doctype.name && E(j, n.ownerDocument.doctype.name) && (m = '<!DOCTYPE ' + n.ownerDocument.doctype.name + '>\n' + m),
          we &&
            u([le, ce, se], (e) => {
              m = g(m, e, ' ');
            }),
