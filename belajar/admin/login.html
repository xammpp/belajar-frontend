      ...
      <div class="card login-form">
        <div class="card-body">
          ...
          <form>
            ...
            <div class="mt-3">
              <label class="d-block text-center" style="font-weight: 400" for="">Not register ? <a href="register.html" class="link">Create an account</a></label>
            </div>
